...
class Users(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["links", "users", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["links", "users", ], str]):

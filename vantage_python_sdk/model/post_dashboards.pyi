...
class PostDashboards(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def widget_tokens() -> typing.Type['PostDashboardsWidgetTokens']:
                return PostDashboardsWidgetTokens
        
            @staticmethod
            def saved_filter_tokens() -> typing.Type['PostDashboardsSavedFilterTokens']:
                return PostDashboardsSavedFilterTokens
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["widget_tokens"]) -> 'PostDashboardsWidgetTokens': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["saved_filter_tokens"]) -> 'PostDashboardsSavedFilterTokens': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["title", "end_date", "widget_tokens", "saved_filter_tokens", "date_bin", "date_interval", "start_date", "workspace_token", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["widget_tokens"]) -> typing.Union['PostDashboardsWidgetTokens', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["saved_filter_tokens"]) -> typing.Union['PostDashboardsSavedFilterTokens', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["title", "end_date", "widget_tokens", "saved_filter_tokens", "date_bin", "date_interval", "start_date", "workspace_token", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        widget_tokens: typing.Union['PostDashboardsWidgetTokens', schemas.Unset] = schemas.unset,
        saved_filter_tokens: typing.Union['PostDashboardsSavedFilterTokens', schemas.Unset] = schemas.unset,

...
class PutSegmentsReportSettings(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["include_credits", "include_refunds", "include_discounts", "include_tax", "amortize", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["include_credits", "include_refunds", "include_discounts", "include_tax", "amortize", ], str]):

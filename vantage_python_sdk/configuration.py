...
from vantage_python_sdk.exceptions_base import ApiValueError
from vantage_python_sdk.exceptions import ClientConfigurationError
...
class Configuration(object):
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self.host = "https://api.vantage.sh/v2" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger = logging.getLogger("vantage_python_sdk")
...
class OAuth:
    def __init__(self, client_id: typing.AnyStr, client_secret: typing.AnyStr, token_url: str = "https://console.vantage.sh/account/profile") -> None:

...
class RequiredPostCostReportsSettings(TypedDict):
    pass

class OptionalPostCostReportsSettings(TypedDict, total=False):
...
class PostCostReportsSettings(RequiredPostCostReportsSettings, OptionalPostCostReportsSettings):
    pass

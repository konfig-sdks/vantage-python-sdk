...
class RequiredPostSegmentsReportSettings(TypedDict):
    pass

class OptionalPostSegmentsReportSettings(TypedDict, total=False):
...
class PostSegmentsReportSettings(RequiredPostSegmentsReportSettings, OptionalPostSegmentsReportSettings):
    pass

...
from vantage_python_sdk.model.dashboards import Dashboards as DashboardsSchema

from vantage_python_sdk.type.dashboards import Dashboards

from ...api_client import Dictionary
from vantage_python_sdk.pydantic.dashboards import Dashboards as DashboardsPydantic
...
SchemaFor200ResponseBodyApplicationJson = DashboardsSchema
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        **kwargs,
        ...
        if validate:
            return DashboardsPydantic(**raw_response.body)
        return api_client.construct_model_instance(DashboardsPydantic, raw_response.body)

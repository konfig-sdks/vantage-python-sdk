...
class BaseApi(api_client.Api):
    ...
    def _get_specific_grant_mapped_args(
        self,
    ...
    async def _aget_specific_grant_oapg(
        self,
...
class GetSpecificGrantRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_specific_grant(
        self,
        access_grant_token: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_specific_grant_mapped_args(
            access_grant_token=access_grant_token,
        )
        return await self._aget_specific_grant_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_specific_grant(
        self,
        access_grant_token: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_specific_grant_oapg(
            path_params=args.path,
        )

class GetSpecificGrant(BaseApi):
    ...
    async def aget_specific_grant(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_specific_grant(
            access_grant_token=access_grant_token,
            **kwargs,
        )
        if validate:
    ...
    def get_specific_grant(
        ...
        raw_response = self.raw.get_specific_grant(
            access_grant_token=access_grant_token,
        )
        if validate:
            return AccessGrantPydantic(**raw_response.body)

...
class BaseApi(api_client.Api):
    ...
    def _get_report_notification_mapped_args(
        self,
    ...
    async def _aget_report_notification_oapg(
        self,
    ...
    def _get_report_notification_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetReportNotificationRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_report_notification(
        self,
        report_notification_token: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_report_notification_mapped_args(
            report_notification_token=report_notification_token,
        )
        return await self._aget_report_notification_oapg(
    ...
    def get_report_notification(
        ...
        return self._get_report_notification_oapg(
            path_params=args.path,
        )

class GetReportNotification(BaseApi):
    ...
    async def aget_report_notification(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_report_notification(
            report_notification_token=report_notification_token,
            **kwargs,
        )
        if validate:
    ...
    def get_report_notification(
        ...
        raw_response = self.raw.get_report_notification(
            report_notification_token=report_notification_token,
        )
        if validate:
            return ReportNotificationPydantic(**raw_response.body)

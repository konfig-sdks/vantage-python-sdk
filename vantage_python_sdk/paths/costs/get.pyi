...
from vantage_python_sdk.model.costs import Costs as CostsSchema

from vantage_python_sdk.type.costs import Costs
from vantage_python_sdk.type.errors import Errors

from ...api_client import Dictionary
from vantage_python_sdk.pydantic.costs import Costs as CostsPydantic
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'groupings': typing.Union[GroupingsSchema, list, tuple, ],
...
request_query_cost_report_token = api_client.QueryParameter(
...
request_query_groupings = api_client.QueryParameter(
    name="groupings",
    style=api_client.ParameterStyle.FORM,
    schema=GroupingsSchema,
)
...
SchemaFor200ResponseBodyApplicationJson = CostsSchema
...
SchemaFor402ResponseBodyApplicationJson = ErrorsSchema
...
class BaseApi(api_client.Api):
    ...
    def _list_cost_report_mapped_args(
        self,
        cost_report_token: str,
        start_date: typing.Optional[str] = None,
        end_date: typing.Optional[str] = None,
        groupings: typing.Optional[typing.List[str]] = None,
        ...
        if cost_report_token is not None:
            _query_params["cost_report_token"] = cost_report_token
        if start_date is not None:
            _query_params["start_date"] = start_date
        if end_date is not None:
            _query_params["end_date"] = end_date
        if groupings is not None:
            _query_params["groupings"] = groupings
    ...
    async def _alist_cost_report_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            request_query_cost_report_token,
            request_query_start_date,
            request_query_end_date,
            request_query_groupings,
            request_query_order,
            request_query_limit,
        ):
...
class ListCostReportRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_cost_report(
        self,
        cost_report_token: str,
        start_date: typing.Optional[str] = None,
        end_date: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._list_cost_report_mapped_args(
        ...
        return await self._alist_cost_report_oapg(
    ...
    def list_cost_report(
        ...
        return self._list_cost_report_oapg(
            query_params=args.query,
        )

class ListCostReport(BaseApi):
    ...
    async def alist_cost_report(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_cost_report(
            cost_report_token=cost_report_token,
            start_date=start_date,
            end_date=end_date,
            groupings=groupings,
        ...
        if validate:
            return CostsPydantic(**raw_response.body)
        return api_client.construct_model_instance(CostsPydantic, raw_response.body)
    ...
    def list_cost_report(
        ...
        raw_response = self.raw.list_cost_report(
            cost_report_token=cost_report_token,
            start_date=start_date,
            end_date=end_date,
            groupings=groupings,

...
SchemaFor204ResponseBodyApplicationJson = SegmentSchema
...
class BaseApi(api_client.Api):
    ...
    def _remove_segment_mapped_args(
        self,
        segment_token: str,
    ...
    async def _aremove_segment_oapg(
        self,
...
class RemoveSegmentRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_segment(
        self,
        segment_token: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._remove_segment_mapped_args(
            segment_token=segment_token,
        )
        return await self._aremove_segment_oapg(
    ...
    def remove_segment(
        ...
        return self._remove_segment_oapg(
            path_params=args.path,
        )

class RemoveSegment(BaseApi):
    ...
    async def aremove_segment(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_segment(
            segment_token=segment_token,
            **kwargs,
        )
        if validate:
    ...
    def remove_segment(
        ...
        raw_response = self.raw.remove_segment(
            segment_token=segment_token,
        )
        if validate:
            return SegmentPydantic(**raw_response.body)

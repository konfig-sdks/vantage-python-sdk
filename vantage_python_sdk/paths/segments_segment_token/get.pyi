...
class BaseApi(api_client.Api):
    ...
    def _get_segment_by_id_mapped_args(
        self,
        segment_token: str,
    ...
    async def _aget_segment_by_id_oapg(
        self,
...
class GetSegmentByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_segment_by_id(
        self,
        segment_token: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_segment_by_id_mapped_args(
            segment_token=segment_token,
        )
        return await self._aget_segment_by_id_oapg(
    ...
    def get_segment_by_id(
        ...
        return self._get_segment_by_id_oapg(
            path_params=args.path,
        )

class GetSegmentById(BaseApi):
    ...
    async def aget_segment_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_segment_by_id(
            segment_token=segment_token,
            **kwargs,
        )
        if validate:
    ...
    def get_segment_by_id(
        ...
        raw_response = self.raw.get_segment_by_id(
            segment_token=segment_token,
        )
        if validate:
            return SegmentPydantic(**raw_response.body)

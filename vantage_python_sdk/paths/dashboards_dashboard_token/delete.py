...
SchemaFor204ResponseBodyApplicationJson = DashboardSchema
...
class BaseApi(api_client.Api):
    ...
    def _delete_dashboard_mapped_args(
        self,
        dashboard_token: str,
    ...
    async def _adelete_dashboard_oapg(
        self,
...
class DeleteDashboardRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_dashboard(
        self,
        dashboard_token: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_dashboard_mapped_args(
            dashboard_token=dashboard_token,
        )
        return await self._adelete_dashboard_oapg(
...
class DeleteDashboard(BaseApi):
    ...
    async def adelete_dashboard(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_dashboard(
            dashboard_token=dashboard_token,
            **kwargs,
        )
        if validate:
    ...
    def delete_dashboard(
        ...
        raw_response = self.raw.delete_dashboard(
            dashboard_token=dashboard_token,
        )
        if validate:
            return DashboardPydantic(**raw_response.body)

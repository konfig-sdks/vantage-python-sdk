...
class BaseApi(api_client.Api):
    ...
    def _get_specific_dashboard_mapped_args(
        self,
        dashboard_token: str,
    ...
    async def _aget_specific_dashboard_oapg(
        self,
    ...
    def _get_specific_dashboard_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetSpecificDashboardRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_specific_dashboard(
        self,
        dashboard_token: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_specific_dashboard_mapped_args(
            dashboard_token=dashboard_token,
        )
        return await self._aget_specific_dashboard_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_specific_dashboard(
        self,
        dashboard_token: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_specific_dashboard_oapg(
            path_params=args.path,
        )

class GetSpecificDashboard(BaseApi):
    ...
    async def aget_specific_dashboard(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_specific_dashboard(
            dashboard_token=dashboard_token,
            **kwargs,
        )
        if validate:
    ...
    def get_specific_dashboard(
        ...
        raw_response = self.raw.get_specific_dashboard(
            dashboard_token=dashboard_token,
        )
        if validate:
            return DashboardPydantic(**raw_response.body)

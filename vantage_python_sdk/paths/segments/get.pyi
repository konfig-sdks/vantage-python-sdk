...
from vantage_python_sdk.model.segments import Segments as SegmentsSchema

from vantage_python_sdk.type.segments import Segments

from ...api_client import Dictionary
from vantage_python_sdk.pydantic.segments import Segments as SegmentsPydantic
...
SchemaFor200ResponseBodyApplicationJson = SegmentsSchema
...
class List(BaseApi):
    ...
    async def alist(
        ...
        **kwargs,
        ...
        if validate:
            return SegmentsPydantic(**raw_response.body)
        return api_client.construct_model_instance(SegmentsPydantic, raw_response.body)

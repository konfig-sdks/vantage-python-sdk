...
class BaseApi(api_client.Api):
    ...
    def _get_specific_folder_mapped_args(
        self,
        folder_token: str,
    ...
    async def _aget_specific_folder_oapg(
        self,
...
class GetSpecificFolderRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_specific_folder(
        self,
        folder_token: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_specific_folder_mapped_args(
            folder_token=folder_token,
        )
        return await self._aget_specific_folder_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_specific_folder(
        self,
        folder_token: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_specific_folder_oapg(
            path_params=args.path,
        )

class GetSpecificFolder(BaseApi):
    ...
    async def aget_specific_folder(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_specific_folder(
            folder_token=folder_token,
            **kwargs,
        )
        if validate:
    ...
    def get_specific_folder(
        ...
        raw_response = self.raw.get_specific_folder(
            folder_token=folder_token,
        )
        if validate:
            return FolderPydantic(**raw_response.body)

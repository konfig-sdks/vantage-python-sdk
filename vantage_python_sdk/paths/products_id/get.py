...
from vantage_python_sdk.model.product import Product as ProductSchema

from vantage_python_sdk.type.product import Product

from ...api_client import Dictionary
from vantage_python_sdk.pydantic.product import Product as ProductPydantic
...
class GetProductRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_product(
        self,
        id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_product_mapped_args(
            id=id,
        )
        return await self._aget_product_oapg(
...
class GetProduct(BaseApi):
    ...
    async def aget_product(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_product(
            id=id,
            **kwargs,
        )
        if validate:
    ...
    def get_product(
        ...
        raw_response = self.raw.get_product(
            id=id,
        )
        if validate:
            return ProductPydantic(**raw_response.body)

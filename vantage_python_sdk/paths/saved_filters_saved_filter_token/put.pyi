...
from vantage_python_sdk.model.put_saved_filters import PutSavedFilters as PutSavedFiltersSchema
...
from vantage_python_sdk.type.put_saved_filters import PutSavedFilters
...
from vantage_python_sdk.pydantic.put_saved_filters import PutSavedFilters as PutSavedFiltersPydantic
...
# body param
SchemaForRequestBodyApplicationJson = PutSavedFiltersSchema


request_body_put_saved_filters = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = SavedFilterSchema
...
class BaseApi(api_client.Api):
    ...
    def _update_saved_filter_for_cost_reports_mapped_args(
        self,
    ...
    async def _aupdate_saved_filter_for_cost_reports_oapg(
        self,
        ...
        **kwargs,
        ...
        serialized_data = request_body_put_saved_filters.serialize(body, content_type)
    ...
    def _update_saved_filter_for_cost_reports_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateSavedFilterForCostReportsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_saved_filter_for_cost_reports(
        self,
        saved_filter_token: str,
        title: typing.Optional[str] = None,
        filter: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._update_saved_filter_for_cost_reports_mapped_args(
            saved_filter_token=saved_filter_token,
            title=title,
            filter=filter,
        )
        return await self._aupdate_saved_filter_for_cost_reports_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def update_saved_filter_for_cost_reports(
        self,
        saved_filter_token: str,
        title: typing.Optional[str] = None,
        filter: typing.Optional[str] = None,
        ...
        return self._update_saved_filter_for_cost_reports_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateSavedFilterForCostReports(BaseApi):
    ...
    async def aupdate_saved_filter_for_cost_reports(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_saved_filter_for_cost_reports(
            saved_filter_token=saved_filter_token,
            title=title,
            filter=filter,
            **kwargs,
    ...
    def update_saved_filter_for_cost_reports(
        ...
        raw_response = self.raw.update_saved_filter_for_cost_reports(
            saved_filter_token=saved_filter_token,
            title=title,
            filter=filter,
        )

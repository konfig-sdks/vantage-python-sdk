...
class BaseApi(api_client.Api):
    ...
    def _get_saved_filter_mapped_args(
        self,
    ...
    async def _aget_saved_filter_oapg(
        self,
...
class GetSavedFilterRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_saved_filter(
        self,
        saved_filter_token: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_saved_filter_mapped_args(
            saved_filter_token=saved_filter_token,
        )
        return await self._aget_saved_filter_oapg(
    ...
    def get_saved_filter(
        ...
        return self._get_saved_filter_oapg(
            path_params=args.path,
        )

class GetSavedFilter(BaseApi):
    ...
    async def aget_saved_filter(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_saved_filter(
            saved_filter_token=saved_filter_token,
            **kwargs,
        )
        if validate:
    ...
    def get_saved_filter(
        ...
        raw_response = self.raw.get_saved_filter(
            saved_filter_token=saved_filter_token,
        )
        if validate:
            return SavedFilterPydantic(**raw_response.body)

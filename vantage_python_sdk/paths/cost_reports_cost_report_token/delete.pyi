...
SchemaFor204ResponseBodyApplicationJson = CostReportSchema
...
class BaseApi(api_client.Api):
    ...
    def _delete_cost_report_mapped_args(
        self,
    ...
    async def _adelete_cost_report_oapg(
        self,
...
class DeleteCostReportRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_cost_report(
        self,
        cost_report_token: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_cost_report_mapped_args(
            cost_report_token=cost_report_token,
        )
        return await self._adelete_cost_report_oapg(
    ...
    def delete_cost_report(
        ...
        return self._delete_cost_report_oapg(
            path_params=args.path,
        )

class DeleteCostReport(BaseApi):
    ...
    async def adelete_cost_report(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_cost_report(
            cost_report_token=cost_report_token,
            **kwargs,
        )
        if validate:
    ...
    def delete_cost_report(
        ...
        raw_response = self.raw.delete_cost_report(
            cost_report_token=cost_report_token,
        )
        if validate:
            return CostReportPydantic(**raw_response.body)

...
class BaseApi(api_client.Api):
    ...
    def _get_cost_report_mapped_args(
        self,
    ...
    async def _aget_cost_report_oapg(
        self,
...
class GetCostReportRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_cost_report(
        self,
        cost_report_token: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_cost_report_mapped_args(
            cost_report_token=cost_report_token,
        )
        return await self._aget_cost_report_oapg(
    ...
    def get_cost_report(
        ...
        return self._get_cost_report_oapg(
            path_params=args.path,
        )

class GetCostReport(BaseApi):
    ...
    async def aget_cost_report(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_cost_report(
            cost_report_token=cost_report_token,
            **kwargs,
        )
        if validate:
    ...
    def get_cost_report(
        ...
        raw_response = self.raw.get_cost_report(
            cost_report_token=cost_report_token,
        )
        if validate:
            return CostReportPydantic(**raw_response.body)

...
from vantage_python_sdk.model.put_business_metrics import PutBusinessMetrics as PutBusinessMetricsSchema
from vantage_python_sdk.model.put_business_metrics_values import PutBusinessMetricsValues as PutBusinessMetricsValuesSchema
from vantage_python_sdk.model.put_business_metrics_cost_report_tokens_with_metadata import PutBusinessMetricsCostReportTokensWithMetadata as PutBusinessMetricsCostReportTokensWithMetadataSchema
...
from vantage_python_sdk.type.put_business_metrics import PutBusinessMetrics
...
from vantage_python_sdk.pydantic.put_business_metrics_cost_report_tokens_with_metadata import PutBusinessMetricsCostReportTokensWithMetadata as PutBusinessMetricsCostReportTokensWithMetadataPydantic
from vantage_python_sdk.pydantic.put_business_metrics_values import PutBusinessMetricsValues as PutBusinessMetricsValuesPydantic
from vantage_python_sdk.pydantic.put_business_metrics import PutBusinessMetrics as PutBusinessMetricsPydantic
...
# body param
SchemaForRequestBodyApplicationJson = PutBusinessMetricsSchema


request_body_put_business_metrics = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_existing_metric_mapped_args(
        self,
        business_metric_token: str,
        title: typing.Optional[str] = None,
        cost_report_tokens_with_metadata: typing.Optional[PutBusinessMetricsCostReportTokensWithMetadata] = None,
        values: typing.Optional[PutBusinessMetricsValues] = None,
    ...
    async def _aupdate_existing_metric_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/business_metrics/{business_metric_token}',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        serialized_data = request_body_put_business_metrics.serialize(body, content_type)
    ...
    def _update_existing_metric_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class UpdateExistingMetricRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_existing_metric(
        self,
        business_metric_token: str,
        title: typing.Optional[str] = None,
        cost_report_tokens_with_metadata: typing.Optional[PutBusinessMetricsCostReportTokensWithMetadata] = None,
    ...
    def update_existing_metric(
        ...
        return self._update_existing_metric_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateExistingMetric(BaseApi):
    ...
    async def aupdate_existing_metric(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_existing_metric(
            business_metric_token=business_metric_token,
            title=title,
            cost_report_tokens_with_metadata=cost_report_tokens_with_metadata,
            values=values,
    ...
    def update_existing_metric(
        ...
        raw_response = self.raw.update_existing_metric(
            business_metric_token=business_metric_token,
            title=title,
            cost_report_tokens_with_metadata=cost_report_tokens_with_metadata,
            values=values,

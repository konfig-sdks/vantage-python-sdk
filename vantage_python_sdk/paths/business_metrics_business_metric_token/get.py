...
SchemaFor200ResponseBodyApplicationJson = BusinessMetricSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_metric_by_id_mapped_args(
        self,
    ...
    async def _aget_metric_by_id_oapg(
        self,
...
class GetMetricByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_metric_by_id(
        self,
        business_metric_token: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_metric_by_id_mapped_args(
            business_metric_token=business_metric_token,
        )
        return await self._aget_metric_by_id_oapg(
    ...
    def get_metric_by_id(
        ...
        return self._get_metric_by_id_oapg(
            path_params=args.path,
        )

class GetMetricById(BaseApi):
    ...
    async def aget_metric_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_metric_by_id(
            business_metric_token=business_metric_token,
            **kwargs,
        )
        if validate:
    ...
    def get_metric_by_id(
        ...
        raw_response = self.raw.get_metric_by_id(
            business_metric_token=business_metric_token,
        )
        if validate:
            return BusinessMetricPydantic(**raw_response.body)

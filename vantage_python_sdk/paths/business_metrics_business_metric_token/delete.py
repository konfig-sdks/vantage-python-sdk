...
SchemaFor204ResponseBodyApplicationJson = BusinessMetricSchema
...
class BaseApi(api_client.Api):
    ...
    def _delete_existing_metric_mapped_args(
        self,
    ...
    async def _adelete_existing_metric_oapg(
        self,
    ...
    def _delete_existing_metric_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteExistingMetricRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_existing_metric(
        self,
        business_metric_token: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_existing_metric_mapped_args(
            business_metric_token=business_metric_token,
        )
        return await self._adelete_existing_metric_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def delete_existing_metric(
        self,
        business_metric_token: str,
    ) -> typing.Union[
        ApiResponseFor204,
        ...
        return self._delete_existing_metric_oapg(
            path_params=args.path,
        )

class DeleteExistingMetric(BaseApi):
    ...
    async def adelete_existing_metric(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_existing_metric(
            business_metric_token=business_metric_token,
            **kwargs,
        )
        if validate:
    ...
    def delete_existing_metric(
        ...
        raw_response = self.raw.delete_existing_metric(
            business_metric_token=business_metric_token,
        )
        if validate:
            return BusinessMetricPydantic(**raw_response.body)
